...
class PeminjamanBarang extends CI_Controller{
	public function __construct(){
		...
		$this->data['aktif'] = 'PeminjamanBarang';
	...
	public function index(){
		...
		$this->data['titleHead'] = 'Mekanik | Peminjaman Barang';
		$this->data['all_barang'] = $this->m_peminjaman_barang->lihat(); 
		$this->data['no'] = 1;

		$this->load->view('purchasingMekanik/inventaris/pinjamBarang/lihat', $this->data);
	}
	...
	public function tambah(){  
		...
		$this->data['all_alat'] = $this->m_barang_pinjam->lihat_alat(); 
        // $nourut = substr($dariDB, 3, 4);
		// $kodeBarangSekarang = $nourut + 1;
		// $this->data['kode_pinjam'] = $kodeBarangSekarang;
		$this->load->view('purchasingMekanik/inventaris/pinjamBarang/tambah', $this->data);
	}
    ...
    {
        $this->load->view('purchasingMekanik/inventaris/pinjamBarang/keranjang');
    } 
	...
	public function proses_tambah(){ 
		...
		for ($i = 0; $i < $jumlah_barang_dikeluar; $i++) {
			...
			$data_detail_keluar[$i]['peruntukan'] = $this->input->post('alat_hidden')[$i]; 
			$data_detail_keluar[$i]['divisi'] = $this->input->post('divisi_hidden')[$i]; 
