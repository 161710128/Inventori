...
class DashboardQc extends CI_Controller{
	public function __construct(){
		parent::__construct();
		if($this->session->login['role'] != 'super' && $this->session->login['role'] != 'quality' && $this->session->login['role'] != 'supervisor') redirect();
		$this->data['aktif'] = 'DashboardQc'; 
	...
	public function index(){
		...
		$this->load->view('qualityControl/dashboard/qc', $this->data);
	} 
}