...
class MasterAlat extends CI_Controller{
	public function __construct(){ 
		parent::__construct();
		if($this->session->login['role'] != 'super' && $this->session->login['role'] != 'quality') redirect();
		$this->data['aktif'] = 'MasterAlat';
	...
	public function index(){
		...
		$this->load->view('qualityControl/dataMaster/lihat', $this->data);
	}
	...
	public function tambah(){ 
		...
		$this->load->view('qualityControl/dataMaster/tambah_alat', $this->data);
	}
	...
	public function proses_tambah(){ 
		$data = [ 
			...
			'total_accept' => $this->input->post('total'),
		...
		if($this->m_master->tambahAlat($data)){
			...
			redirect('QualityControl/MasterAlat');
		} else {
	...
	public function ubah($kode_komponen){ 
		...
		$this->load->view('qualityControl/dataMaster/ubah_alat', $this->data);
	}
