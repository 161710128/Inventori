          ...
          <div class="row"> 
              <div class="col-md-6"> 
                  <div class="card card-primary">
                      ...
                      <form action="<?= base_url('PemesananBarang/NonEkatalog/proses_tambah') ?>" id="form-tambah" method="POST">
                        <div class="card-body">
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="kode_pemesanan"><strong>Kode Pemesanan</strong></label>
                              <input type="text" name="kode_pemesanan" autocomplete="off" class="form-control" required value="NA<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="no_order"><strong>Nomor Order</strong></label>
                              <input type="text" name="no_order" placeholder="Masukkan ID Paket" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="customer"><strong>Customer</strong></label>
                              <input type="text" name="customer" placeholder="Masukkan Customer" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                          ...
                          <div class="form-row"> 
                            <div class="form-group col-md-6"> 
                                <label><strong>Tanggal Deadline</strong></label>
