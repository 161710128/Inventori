          ...
          <div class="row"> 
              <div class="col-md-6"> 
                  <div class="card card-primary">
                      ...
                      <form action="<?= base_url('PemesananBarang/Ekatalog/proses_ubah/' . $barang->kode_pemesanan) ?>" id="form-tambah" method="POST">
                        <div class="card-body">
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <input type="text" name="id_paket" placeholder="Masukkan ID Paket" autocomplete="off" class="form-control" value="<?= $barang->id_paket ?>">
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="pemesanan"><strong>Pemesanan</strong></label>
                              <input type="text" name="pemesanan" placeholder="Masukkan Pemesanan" autocomplete="off" class="form-control" value="<?= $barang->pemesanan ?>" >
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="distributor"><strong>Distributor</strong></label>
                              <input type="text" name="distributor" placeholder="Masukkan Distributor" autocomplete="off" class="form-control" value="<?= $barang->distributor ?>" >
                            </div>
                            <div class="form-group col-md-6">
                              <label for="nama_alat"><strong>Nama Alat</strong></label>
                              <input type="text" name="nama_alat" placeholder="Masukkan Nama Alat" autocomplete="off" class="form-control" value="<?= $barang->nama_alat ?>" >
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
