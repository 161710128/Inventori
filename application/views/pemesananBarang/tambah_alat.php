      ...
      <div class="container-fluid">
        <div class="row mb-2">  
          <div class="col-sm-6"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('PemesananBarang/Ekatalog') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>  
      </div> 
    </div> 
          ...
          <div class="row"> 
              <div class="col-md-6"> 
                  <div class="card card-primary">
                      ...
                      <form action="<?= base_url('PemesananBarang/Ekatalog/proses_tambah') ?>" id="form-tambah" method="POST">
                        <div class="card-body">
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="kode_pemesanan"><strong>Kode Pemesanan</strong></label>
                              <input type="text" name="kode_pemesanan" autocomplete="off" class="form-control" required value="KA<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="id_paket"><strong>ID Paket</strong></label>
                              <input type="text" name="id_paket" placeholder="Masukkan ID Paket" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="pemesanan"><strong>Pemesanan</strong></label>
                              <input type="text" name="pemesanan" placeholder="Masukkan Pemesanan" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="distributor"><strong>Distributor</strong></label>
                              <input type="text" name="distributor" placeholder="Masukkan Distributor" autocomplete="off" class="form-control" required>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="nama_alat"><strong>Nama Alat</strong></label>
                              <input type="text" name="nama_alat" placeholder="Masukkan Nama Alat" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <label for="quantity"><strong>Quantity</strong></label>
                              <input type="number" name="quantity"  min = "1" autocomplete="off" class="form-control" onkeypress='validate(event)' required>
                            </div>
                            <div class="form-group col-md-6"> 
                                <label><strong>Tanggal Deadline Kontrak</strong></label>
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" name ="reservationdate" class="form-control datetimepicker-input" data-target="#reservationdate" required>
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" name="catatan" placeholder="Masukkan Catatan" autocomplete="off" class="form-control" required>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="id_barangpemesanan">Nama Barang</label>
                              <select name="id_barangpemesanan" id="id_barangpemesanan" class="form-control" required>
                                  <option value="">Pilih Barang</option> 
                                      <option value="6">USG</option> 
                                      <option value="5">HFNC</option> 
                                      <option value="7">Dexin</option> 
                                      <option value="1">Antropometri</option> 
                                      <option value="2">Lansia Kit & Posyandu</option> 
                                      <option value="3">Endoskopi, Laparoskopi & Lightsouce</option> 
                                      <option value="4">Infusepump, Syringepump & Pasienmonitor</option>  
                              </select>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12"> 
                              <input type="hidden" name="status" value="pesan" autocomplete="off" class="form-control" required>
                            </div> 
                          </div> 
                        </div> 
