                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title float-right"><a href="<?= base_url('Pengguna_QC/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    <?php foreach ($all_petugas as $petugas) : ?>
                                                        <tr>
                                                            ...
                                                            <?php
                                                            // if ($this->session->login['role'] == 'quality') : 
                                                            ?>
                                                            <td><?= $petugas->password ?></td>
                                                            <td>
                                                                <a href="<?= base_url('Pengguna_QC/ubah/') . $petugas->kode ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
