						...
						<div class="row">
							<div class="col-lg-12">
								<div class="p-5">
									...
									<img src="<?=base_url()?>assets/foto/gerlink.png" alt="" width="150" height="150"><br><br><br>
									...
									<form class="user" method="POST" action="<?= base_url('login/proses_login') ?>">
										...
										<div class="form-group">
											<select name="role" id="role" class="form-control" required>
												...
												<!-- <option value="gudang_bahan_tools">GudangBahan | Tools</option>  -->
												<option value="mekanik">GudangBahan | Raw Material</option> 
