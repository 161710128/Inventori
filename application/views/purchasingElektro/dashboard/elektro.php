    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-4">
            <!-- small box -->
            <div class="small-box bg-pink" data-aos="fade-down">
              <div class="inner">
                <!-- <h3><?= $JKomponenKeluar?></h3> -->
                <br>
                <h3><?= $jumlah_pengambilan ?></h3>
                <p>Pengambil Barang</p>
              </div>
              <div class="icon">
                <i class="ion ion-archive"></i>
              </div>
