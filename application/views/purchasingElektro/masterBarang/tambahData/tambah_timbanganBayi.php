 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('BarangElektro/antropometri') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('purchasingElektro/BarangElektro/proses_tambah_timbanganBayi') ?>" id="form-tambah" method="POST"> 
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="kode_komponen"><strong>Kode Komponen</strong></label>
                      <input type="text" name="kode_komponen" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control" required value="EB<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
                    </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="harga_satuan" placeholder="Masukkan Stok" autocomplete="off" class="form-control" required>
                    </div> 
                    <div class="form-group col-md-6">
                  ...
                  <div class="form-row">
                    ...
                    <!-- <div class="form-group col-md-6">
                      ...
                      <select name="stok_alat" id="stok_alat" class="form-control">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="nama_toko" placeholder="Masukkan Nama Toko" autocomplete="off" class="form-control" required>
                    </div>  
                  </div>  
