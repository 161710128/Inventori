        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('purchasingElektro/BarangElektro/proses_ubah_timbanganDewasa/' . $barang->kode_komponen) ?>" id="form-tambah" method="POST">
              <div class="card-body">
                  <div class="form-row">
                  ...
                  <input type="hidden" name="keterangan" value="<?= $barang->keterangan ?>">
