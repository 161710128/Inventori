  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
						<!-- <a href="<?= base_url('PenerimaanElektro/export_detail/' . $penerimaan->kode_transaksi) ?>" class="btn btn-danger btn-sm" target="_blank"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a> -->
						<a href="<?= base_url('PengeluaranElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="container-fluid">
		<div class="card">
					<div class="card-header"><strong><?= $title ?> - <?= $pengeluaran->kode_transaksi ?></strong></div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<table class="table table-bordered" id="example1" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th><strong>Peruntukan</strong></th>
											<th><strong>Stok Barang</strong></th>
											<th><strong>Keterangan</strong></th>
											<th><strong>Pengambil</strong></th>
									...
									<tbody>
										<?php foreach ($all_detail_keluar as $detail_keluar): ?>
											<tr>
												...
												<td><?= $detail_keluar->stok_alat ?></td> 
												<td><?= $detail_keluar->keterangan ?></td> 
												<td><?= $detail_keluar->pengambil ?></td> 
                        <td><?= $detail_keluar->shift ?></td> 
                        <!--<td><?= $detail_keluar->tanggal_keluar ?></td> -->
                        <!--<td><?= $detail_keluar->jam_keluar ?></td>-->

                          <!-- <?php if ($detail_keluar->id_barang == 1) : ?>
                            <td>HFNC</td>
                          <?php elseif ($detail_keluar->id_barang == 2) : ?>
                            <td>Antropometri</td>
                          <?php elseif ($detail_keluar->id_barang == 7) : ?>
                          <td>Timbangan Dewasa</td>
                          <?php endif; ?> --> 
											</tr>
										<?php endforeach ?>
