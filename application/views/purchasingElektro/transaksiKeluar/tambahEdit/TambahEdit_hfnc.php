  ...
  <!-- Navbar -->
	...
	<!-- /.navbar -->
		...
		<div id="content-wrapper" class="content-wrapper" > 
			...
			<section id="content" class="content" data-url="<?= base_url('PurchasingElektro/PengeluaranElektro') ?>">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									...
									<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
										<li><a href="<?= base_url('PurchasingElektro/PengeluaranElektro/tambahUbah_Hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li>   
										<li><a href="<?= base_url('PurchasingElektro/PengeluaranElektro/tambahUbah_Antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
									</ul> 
							...
							<!-- /.card-header -->
								<div class="card-body">
									<form action="<?= base_url('PurchasingElektro/PengeluaranElektro/prosesTambahEdit') ?>" id="form-tambah" method="POST">
										<h5>Data Pengguna</h5>
										<hr>
										<div class="form-row">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="form-row">
													...
													<input type="hidden" name="stok_alat" value= "<?= $komponen->stok_alat ?>">
													<input type="hidden" name="keterangan" value="<?= $komponen->keterangan ?>">
												</div>
											</div>
										</div>
										<div class="keranjang">
											...
											<table class="table table-bordered" id="keranjang">
												<thead>
													<tr>
													<td width="10%">Kode Komponen</td>
														<td width="25%">Nama Komponen</td>
														...
														<!--<td width="5%">Tanggal Keluar</td>-->
														<!--<td width="5%">Jam Keluar</td>-->
