                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
                                                    <li><a href="<?= base_url('PurchasingElektro/PengeluaranElektro/tambahTimbanganDewasa') ?>" class="dropdown-item">Timbangan Dewasa</a></li>   
											        <li><a href="<?= base_url('PurchasingElektro/PengeluaranElektro/tambahTimbanganBayi') ?>" class="dropdown-item">Timbangan Bayi</a></li> 
												</ul>
                                            </h3>  
                                            <div class="float-right"><a href="<?= base_url('PurchasingElektro/PengeluaranElektro/tambahAntropometri') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?= base_url('PurchasingElektro/PengeluaranElektro/prosesTambah_timbanganBayi') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <!-- <input type="text" id = "jumlah1" name="jumlah1" value="">
                                                            <input type="number" id = "jumlah2" name="jumlah2" value="">
                                                            <input type="number" id = "jumlah3" name="jumlah3" value=""> -->
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="keranjang">
        ...
        $(document).ready(function() {
            ...
            $('#kode_komponen').on('change', function() {
                ...
                if ($(this).val() == '') reset()
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>PurchasingElektro/PengeluaranElektro/get_all_barang",
                        type: 'POST',
                        dataType: 'json',
                        data: {
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                $.ajax({
                    url: "<?= base_url() ?>PurchasingElektro/PengeluaranElektro/keranjang_barang",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
