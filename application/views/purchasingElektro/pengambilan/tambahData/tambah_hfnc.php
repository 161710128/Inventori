                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
													<li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahHfnc') ?>" class="dropdown-item">HFNC</a></li>   
											        <li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahAntropometri') ?>" class="dropdown-item">Antropometri</a></li> 
												</ul>
                                            </h3>  
                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('PurchasingElektro/PengambilanElektro/proses_tambahHFNC') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
