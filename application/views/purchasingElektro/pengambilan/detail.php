  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
 						<a href="<?= base_url('PurchasingElektro/PengambilanElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
							...
							<div class="col-md-6">
								<table class="table table-borderless">
									...
									<tr>
										...
										<td>:</td>
										<td><?= $penerimaan->tanggal_keluar ?></td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<table class="table table-bordered" id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<?php foreach ($all_detail_terima as $detail_keluar): ?>
											<tr>
												<td><?= $no++ ?></td>
