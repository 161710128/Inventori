  ...
  <!-- Navbar -->
	...
	<!-- /.navbar -->
		...
		<div id="content-wrapper" class="content-wrapper" > 
			...
			<section id="content" class="content" data-url="<?= base_url('PurchasingElektro/PengambilanElektro') ?>">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									...
									<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
										<li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahUbah_timbanganDewasa/' . $barang->kode_transaksi) ?>" class="dropdown-item">Timbangan Dewasa</a></li>   
										<li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahUbah_timbanganBayi/' . $barang->kode_transaksi) ?>" class="dropdown-item">Timbangan Bayi</a></li> 
									</ul>
								</h3>  
								<div class="float-right"><a href="<?= base_url('PurchasingElektro/PengambilanElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
								
							</div>
							<!-- /.card-header -->
								<div class="card-body">
									<form action="<?= base_url('PurchasingElektro/PengambilanElektro/prosesTambahEdit') ?>" id="form-tambah" method="POST">
										<h5>Data Pengguna</h5>
										<hr>
										<div class="form-row">
											...
											<div class="form-group col-2">
												...
												<input type="text" name="tanggal_masuk" value="<?= $barang->tanggal_keluar ?>" readonly class="form-control">
											</div>
											<div class="form-group col-2">
												<label>Jam</label>
