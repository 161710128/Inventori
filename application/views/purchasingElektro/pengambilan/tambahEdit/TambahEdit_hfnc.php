							...
							<div class="card-header">
								<h3 class="card-title">
									...
									<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
										<li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahUbah_Hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li>   
										<li><a href="<?= base_url('PurchasingElektro/PengambilanElektro/tambahUbah_Antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
									</ul> 
