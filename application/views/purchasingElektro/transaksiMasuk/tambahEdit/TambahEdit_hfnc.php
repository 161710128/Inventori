				...
				<div class="container-fluid">
					<div class="row mb-2">  
						<div class="col-sm-12"> 
							...
							<!-- <h1 class="float-right"><a href="<?= base_url('PenerimaanElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	 -->
						</div>
					</div>
				</div>
			</div>

			<section id="content" class="content" data-url="<?= base_url('PenerimaanElektro') ?>">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									...
									<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
										<li><a href="<?= base_url('PurchasingElektro/PenerimaanElektro/tambahUbah_Hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li>   
										<li><a href="<?= base_url('PurchasingElektro/PenerimaanElektro/tambahUbah_Antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
									</ul> 
							...
							<!-- /.card-header -->
								<div class="card-body">
									<form action="<?= base_url('PurchasingElektro/PenerimaanElektro/proses_tambahHFNC') ?>" id="form-tambah" method="POST">
										<h5>Data Pengguna</h5>
										<hr>
										<div class="form-row">
