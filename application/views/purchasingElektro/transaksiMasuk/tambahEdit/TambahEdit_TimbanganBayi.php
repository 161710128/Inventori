  ...
  <!-- Navbar -->
	...
	<!-- /.navbar --> 
		...
		<div id="content-wrapper" class="content-wrapper" > 
			...
			<section id="content" class="content" data-url="<?= base_url('PurchasingElektro/PenerimaanElektro') ?>">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									...
									<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
										<li><a href="<?= base_url('PurchasingElektro/PenerimaanElektro/tambahUbah_TimbanganDewasa/' . $barang->kode_transaksi) ?>" class="dropdown-item">Timbangan Dewasa</a></li>   
										<li><a href="<?= base_url('PurchasingElektro/PenerimaanElektro/tambahUbah_TimbanganBayi/' . $barang->kode_transaksi) ?>" class="dropdown-item">Timbangan Bayi</a></li> 
									</ul>  
								</h3>  
								<div class="float-right"><a href="<?= base_url('PurchasingElektro/PenerimaanElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
							</div>
							<!-- /.card-header -->
								<div class="card-body">
									<form action="<?= base_url('PurchasingElektro/PenerimaanElektro/proses_tambahEdit_timbanganBayi') ?>" id="form-tambah" method="POST">
										<h5>Data Pengguna</h5>
										<hr>
										<div class="form-row">
											...
											<div class="form-group col-2">
												...
												<input type="text" name="tanggal_masuk" value="<?= $barang->tanggal_masuk ?>" readonly class="form-control">
											</div>
											<div class="form-group col-2">
												<label>Jam</label>
												<input type="text" name="jam_masuk" value="<?= $barang->jam_masuk ?>" readonly class="form-control">
											</div>
										</div>
										<div class="row"> 
											<div class="col-md-12">
												...
												<div class="form-row">
													...
													<input type="hidden" name="stok_alat" value="Timbangan Bayi">
													<input type="hidden" name="keterangan" value="antropometri">
													<input type="hidden" name="id_barang" value="8">
													<!-- <input type="hidden" id = "jumlah1" name="jumlah1" value="">
													<input type="hidden" id = "jumlah2" name="jumlah2" value="">
													<input type="hidden" id = "jumlah3" name="jumlah3" value=""> -->
												</div> 
											</div>
										</div>
										<div class="keranjang">
        ...
        $(document).ready(function() {
            ...
            $('#kode_komponen').on('change', function() {
                ...
                if ($(this).val() == '') reset()
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>PurchasingElektro/PenerimaanElektro/get_all_barang",
                        type: 'POST',
                        dataType: 'json',
                        data: {
                        ...
                        success: function(data) {
                            // $('input[name="jumlah1"]').val(data.nama_komponen)
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                //     if(document.getElementById("jumlah2").value == "")
                //     {
                //         var jumlah  = $("#jumlah").val();
                //         $("#jumlah3").val(jumlah);
                //         $("#jumlah2").val(jumlah);
                ...
                //     }else {
                //         if (jumlah3 == 1){
                //         var total = parseInt(jumlah) + parseInt(jumlah2);
                //         $("#jumlah3").val(total); 
                //         // jumlah3  = $("#jumlah3").val();
                //         // alert("jumlah2")  
                //         }else{
                //             var total = parseInt(jumlah) + parseInt(jumlah3);
                //             $("#jumlah3").val(total); 
                //         }
                ...
                $.ajax({
                    url: "<?= base_url() ?>PurchasingElektro/PenerimaanElektro/keranjang_barang",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
