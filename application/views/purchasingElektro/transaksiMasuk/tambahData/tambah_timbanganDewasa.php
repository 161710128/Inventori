                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('purchasingElektro/PenerimaanElektro/proses_tambahTimbanganDewasa') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <input type="hidden" name="id_barang" value="7">
