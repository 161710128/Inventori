                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
                                                    <li><a href="<?= base_url('purchasingElektro/PenerimaanElektro/tambahTimbanganDewasa') ?>" class="dropdown-item">Timbangan Dewasa</a></li>   
											        <li><a href="<?= base_url('purchasingElektro/PenerimaanElektro/tambahTimbanganBayi') ?>" class="dropdown-item">Timbangan Bayi</a></li> 
												</ul>
                                            </h3>  
                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('purchasingElektro/PenerimaanElektro/proses_tambahTimbanganBayi') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
													<div class="form-group col-2">
														<label>Kode Transaksi</label>
														<input type="text" name="kode_transaksi" value="TM<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly class="form-control">
													</div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                //     }
                    ...
                    // }
                    // else if (jumlah3 == 2){
                    //     // var total1 = parseInt(jumlah) + parseInt(jumlah3);
                    //     // $("#jumlah3").val(total1);  
                    //     alert("jumlah3")
                    ...
                    // else{
                    //     var total = parseInt(jumlah) + parseInt(jumlah1);
                    //     $("#jumlah3").val(total); 
