 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('purchasingElektro/PenerimaanElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('PurchasingElektro/PenerimaanElektro/proses_tambahTransaksi') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="tanggal_masuk"><strong>Tanggal Transaksi</strong></label>
                      <input type="text" name="tanggal_masuk"  autocomplete="off" class="form-control" value="<?= date('Y/m/d') ?>">
                    </div>
                  </div> 
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="jam_masuk"><strong>Jam</strong></label>
                      <input type="text" name="jam_masuk"  autocomplete="off" class="form-control" value="<?= date('H:i:s') ?>" readonly>
                    </div> 
                </div>
                <!-- /.card-body -->
