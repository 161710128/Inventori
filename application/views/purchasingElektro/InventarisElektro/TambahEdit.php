...
<body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="card-header">
                                            <!-- <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
													<li><a href="<?= base_url('PurchasingElektro/InventarisElektro/tambahHfnc') ?>" class="dropdown-item">HFNC</a></li>   
											        <li><a href="<?= base_url('PurchasingElektro/InventarisElektro/tambahAntropometri') ?>" class="dropdown-item">Antropometri</a></li> 
												</ul>
                                            </h3>   -->
                                            <div class="float-right"><a href="<?= base_url('PurchasingElektro/InventarisElektro') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?= base_url('PurchasingElektro/InventarisElektro/proses_tambahEdit') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-2">
                                                        ...
                                                        <input type="text" name="tanggal_keluar" value="<?= date('d/m/Y') ?>" class="form-control">
                                                    </div>
                                                    <div class="form-group col-2">
                                                        <label>Jam</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-3">
                                                                <label for="nama_komponen">Nama Barang</label>
                                                                <input type="text"  id ="nama_komponen" name="nama_komponen" value="" class="form-control">
                                                            </div>
															<div class="form-group col-1">
                                                                <label>Jumlah</label>
                                                                <input type="number"  id ="jumlah" name="jumlah" value="" class="form-control" min='1'>
                                                            </div> 
                                                            <div class="form-group col-2">
                                                            ...
                                                            <div class="form-group col-1">
                                                                <label for="">&nbsp;</label>
                                                                <button type="button" class="btn btn-primary btn-block" id="tambah" disabled><i class="fa fa-plus"></i></button>
                                                            </div>  
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        let input = document.getElementById("nama_komponen")
    ...
    <script> 
       $(document).ready(function() {
            ...
            //         $.ajax({
            //             url: "<?= base_url() ?>PurchasingElektro/InventarisElektro/get_all_barang",
            //             type: 'POST',
            //             dataType: 'json',
            //             data: {
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                $.ajax({
                    url: "<?= base_url() ?>PurchasingElektro/InventarisElektro/keranjang_barang",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
