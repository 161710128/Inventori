        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('purchasingElektro/InventarisElektro/proses_tambahTransaksi') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="kode_transaksi"><strong>Kode Transaksi</strong></label>
                      <input type="text" name="kode_transaksi" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control"  value="TI<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
