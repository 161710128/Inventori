        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="float-right"><a href="<?= base_url('Packing/HasilPacking') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h3>
                    ...
                    <div class="row"> 
                        <div class="col-md-6">  
                            <div class="card card-primary">
                                ...
                                <form action="<?= base_url('Packing/HasilPacking/proses_tambah') ?>" id="form-tambah" method="POST"> 
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Kode Transaksi</label>
                                            <input type="text" name="kode_transaksi" value="CK<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly class="form-control">
                                        </div>
                                        <div class="form-group">
        ...
        function updateDigitalClock() {
            ...
            $('#kode_alat').on('change', function() {
                ...
                if ($(this).val() == '') reset()
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>Packing/HasilPacking/get_all_barang",
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            kode_alat: $(this).val()
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                $.ajax({
                    url: "<?= base_url() ?>Packing/HasilPacking/keranjang_barang",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
