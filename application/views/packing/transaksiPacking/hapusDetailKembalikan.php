        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url('Packing/PengirimanBarang/proses_pengembalian') ?>" id="form-tambah" method="POST">
			     <input type="hidden" name="kode_transaksi_masuk" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required value="<?= $barang->kode_transaksi_masuk ?>" readonly>
                <div class="card-body">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        <label for="serial_number"><strong>serial_number</strong></label>
                        <input type="text" name="serial_number" placeholder="Masukkan Serial Number" autocomplete="off"  class="form-control" required value="<?= $barang->serial_number ?>" readonly>
                      </div>
                    </div>   
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
					 ...
					 <input type="hidden" name="tanggal" autocomplete="off"  class="form-control" required value="<?= $barang->tanggal?>" readonly>
                <input type="hidden" name="id_detail" value="<?= $barang->id_detail ?>"> 
                <div class="card-footer">
				            <button type="submit" class="btn btn-success"><i class="fa fa-undo"></i>&nbsp;&nbsp;Kembalikan</button> 
                </div>
              </form>
            </div> 
          </div> 
