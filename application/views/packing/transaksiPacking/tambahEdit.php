        ...
        <div class="row">  
          <div class="col-md-6"> 
            <div class="card card-primary">
                ...
                <form action="<?= base_url('Packing/HasilPacking/proses_tambahEdit') ?>" id="form-tambah" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <div class="form-group">
                            <label>Jumlah</label>
                            <input type="number"  id ="serialnumber" name="serialnumber" value="" class="form-control" readonly min='1'>
                        </div>   -->
                        <!-- <div class="form-group">
