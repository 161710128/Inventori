          ...
          <div class="row"> 
              <div class="col-md-6"> 
                  <div class="card card-primary">
                      ...
                      <form action="<?= base_url('Packing/MasterPacking/proses_tambah') ?>" id="form-tambah" method="POST">
                        <div class="card-body">
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="kode_alat"><strong>Kode Alat</strong></label>
                              <input type="text" name="kode_alat" placeholder="Masukkan Kode Job" autocomplete="off" class="form-control" required value="CA<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
                            </div> 
                          </div>
                          <div class="form-row">
                            <div class="form-group col-md-12">
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="number" name="total_stok" placeholder="" autocomplete="off" class="form-control" required>
                            </div> 
                          </div> 
                          <div class="form-row">
                            <div class="form-group col-md-12">
