								...
								<div class="col-12">
									<div class="card">
										<div class="card-header">
											...
											<h3 class="card-title float-right"><a href="<?= base_url('Produksi/MasterProgress/tambah_babyScale') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
										</div>
										<div class="card-body">
														...
														<tr>
															...
															<td>
																<?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'produksi') : ?>
																	<a href="<?= base_url('Produksi/MasterProgress/ubah_babyScale/' . $barang->kode_job) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
																	<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('Produksi/MasterProgress/hapus_babyScale/' . $barang->kode_job) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
																<?php endif; ?>
															</td>
														</tr>
													<?php endforeach ?>
