		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">							
							<h3 class="card-title float-right"><a href="<?= base_url('Produksi/HasilAlat/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
							...
							<div class="row">
								<div class="col-12">
									<div class="card"> 
										...
										<div class="card-body">
						<!-- Your view file -->
											<!-- Your view file (produksi/dataMaster/hasil/master_hasil.php) -->
										<table id="example1" class="table table-bordered table-striped">
											<thead>
												<tr>
													<th><strong>No</strong></th>
													<th><strong>Kode Transaksi</strong></th>
												...
												<tbody>
												<?php foreach ($alltransaksi as $barang) : ?>
													<tr>
														<td><?= $no++ ?></td>	
														...
														<td><?= $barang->nama_pengguna ?></td> 
															...
															<td><?= $newDate?></td>
														<td>
														<a href="<?= base_url('Produksi/HasilAlat/detail/' . $barang->kode_transaksi) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
														<?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'produksi'|| $this->session->login['role'] == 'supervisor') : ?>
																			<!-- <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('PurchasingMekanik/PengeluaranMekanik/hapus/' . $barang	->kode_transaksi) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a> -->
														<?php endif; ?>
														<a href="<?= base_url('Produksi/HasilAlat/ubah/' . $barang->kode_transaksi) ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
														</td>
													</tr>
												<?php endforeach ?> 
											</tbody>
