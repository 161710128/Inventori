      ...
      <div class="container-fluid">
        <div class="row mb-2">  
          <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('produksi/HasilAlat/detail') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <!-- <form action="<?= base_url('Produksi/HasilAlat/proses_detailHapus/' . $barang->kode_part) ?>" id="form-tambah" method="POST"> -->

              <form action="<?= base_url('Produksi/HasilAlat/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="kode_transaksi" placeholder="Masukkan Nama Komponen" autocomplete="off"  class="form-control" required value="<?= $barang->kode_transaksi ?>" readonly>
                      </div>
                    </div>   
                    <div class="form-row">
                       <div class="form-group col-md-6">
                          <label for="total_assy"><strong>Total Assembly</strong></label>
                          <input type="text" name="total_assy" placeholder="Masukkan QTY /Unit" autocomplete="off"  class="form-control" required value="<?= $barang->total_assy?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                          <label for="jumlah"><strong>Shift</strong></label>
                          <input type="text" name="jumlah" placeholder="Masukkan Harga Satuan" autocomplete="off"  class="form-control" required value="<?= $barang->shift ?>"readonly>
                        </div>
                    </div>   
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="keterangan"><strong>Keterangan</strong></label>
                          <input type="text" name="keterangan" autocomplete="off"  class="form-control" required value="<?= $barang->keterangan ?>"readonly>
                        </div>	
                        <div class="form-group col-md-6">
                          <label for="qty_unit"><strong>Waktu</strong></label>
                          <input type="text" name="tanggal" autocomplete="off"  class="form-control" required value="<?= $barang->tanggal?>" readonly>
                        </div>
                    </div>   
                    <!-- <div class="form-row"> 
                      <div class="form-group col-md-6">
