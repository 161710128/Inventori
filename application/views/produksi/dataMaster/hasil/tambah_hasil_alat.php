        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('Produksi/HasilAlat/proses_tambah') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="tanggal_keluar"><strong>Tanggal</strong></label>
                      <input type="text" name="tanggal"  autocomplete="off" class="form-control" value="<?= date('d-m-Y') ?>">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="jam_keluar"><strong>Jam</strong></label>
                      <input type="text" name="jam"  autocomplete="off" class="form-control" value="<?= date('H:i:s') ?>" readonly>
                    </div> 
                  </div> 
