        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <?php if ($this->session->flashdata('sukses_ks')) : ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <?= $this->session->flashdata('sukses_ks') ?>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    <?php elseif($this->session->flashdata('error_ks')) : ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <?= $this->session->flashdata('error_ks') ?>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
													<li><a href="<?= base_url('produksi/KemajuanProduksi/tambah_standingWeight')?>" class="dropdown-item">Standing Weight</a></li>    
													<li><a href="<?= base_url('produksi/KemajuanProduksi/tambah_babyScale')?>" class="dropdown-item">Baby Scale</a></li>    
													<li><a href="<?= base_url('produksi/KemajuanProduksi/tambah_stadioMeter')?>" class="dropdown-item">Stadio Meter</a></li>    
													<li><a href="<?= base_url('produksi/KemajuanProduksi/tambah_infantoMeter')?>" class="dropdown-item">Infanto Meter</a></li>    
													<li><a href="<?= base_url('produksi/KemajuanProduksi/tambah_lila')?>" class="dropdown-item">Lila</a></li>    
												</ul>
                                            </h3>  
