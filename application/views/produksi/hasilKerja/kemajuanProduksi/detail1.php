...
<head>
  ...
  <title><?= $titleHead ?> - <?= $penerimaan->tanggal ?> - <?= $title1 ?></title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
 						<a href="<?= base_url('Produksi/KemajuanProduksi') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
                ...
                <li><a href="<?= base_url('Produksi/KemajuanProduksi/detail_lila/' . $penerimaan->kode_transaksi)?>" class="dropdown-item">Lila</a></li>    
					...
					<div class="card-body">
                      ...
                      <th><strong>No</strong></th>
											<th><strong>Kode Job</strong></th>
											<th><strong>Job / Equipment</strong></th>
											<th><strong>Part Name</strong></th>
											<th><strong>Material / Description</strong></th>
											<th><strong>Nama MP</strong></th>
											<th><strong>Bagus</strong></th>
											<th><strong>Rijek</strong></th>
                      ...
                      <th><strong></strong></th> 
									...
									<tbody>
										<?php foreach ($all_detail_terima as $detail_terima): ?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?= $detail_terima->kode_job ?></td>
												<td><?= $detail_terima->job?></td>
												<td><?= $detail_terima->part_name ?></td>
												<td><?= $detail_terima->jobdesc ?></td>
												<td><?= $detail_terima->nama_mp ?></td>
												<td><?= $detail_terima->bagus ?></td>
												<td><?= $detail_terima->rijek ?></td>
												<td><?= $detail_terima->catatan ?></td>
												<td><?= $detail_terima->nama_barang ?></td>
												<td><?= $detail_terima->nama_shift ?></td>
                        <td><a href="<?= base_url('Produksi/KemajuanProduksi/detailHapus/' . $detail_terima->id_detailmasuk) ?>"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
