        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url('Produksi/StokAlat/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="jumlah_assy"><strong>Jumlah Assembly</strong></label>
                          <input type="text" name="jumlah_assy" placeholder="Masukkan Harga Satuan" autocomplete="off"  class="form-control" required value="<?= $barang->jumlah_assy ?>"readonly>
                        </div>	
                        <div class="form-group col-md-6">
                          <label for="keterangan"><strong>Keterangan</strong></label>
                          <input type="text" name="keterangan" placeholder="Masukkan QTY /Unit" autocomplete="off"  class="form-control" required value="<?= $barang->keterangan?>" readonly>
                        </div>
                    </div>    
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="status_alat"><strong>Status Alat</strong></label>
                          <input type="text" name="status_alat" placeholder="Masukkan Harga Satuan" autocomplete="off"  class="form-control" required value="<?= $barang->status_alat ?>"readonly>
                        </div>	
                        <div class="form-group col-md-6">
                ...
                <input type="hidden" name="id_detail" value="<?= $barang->id_detail_alat ?>"> 
