                                ...
                                <div class="col-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                <strong>Silahkan isi data dibawah !</strong> 
                                            </h3>  
                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('Produksi/StokAlat/proses_tambah') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <!-- <div class="form-row"> -->
													<div class="form-group">
														<label>Kode Transaksi</label>
														<input type="text" name="kode_transaksi" value="PK<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly class="form-control">
													</div>
													<div class="form-group">
