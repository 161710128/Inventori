...
<script>
  function showTwoTextAreaDialog(kode_transaksi) {
    Swal.fire({
      title: 'Masukkan Catatan',
      html: '<label for="myTextArea1">Catatan Mekanik:</label><br><textarea id="myTextArea1" rows="4" cols="45"></textarea><br><label for="myTextArea2">Catatan Elektro:</label><br><textarea id="myTextArea2" rows="4" cols="45"></textarea>',
      confirmButtonText: 'Simpan',
      customClass: {
        confirmButton: 'btne btn-success' // Menambahkan kelas CSS 'btn-success' untuk tombol "Simpan"
      },
...
<script>
  function getTwoTextAreaDialog(kode_transaksi) {
    ...
    Swal.fire({
      ...
      html: `
        <label for="myTextArea1">Catatan Mekanik:</label><br>
        <textarea id="myTextArea1" rows="4" cols="45" >${catatanMekanik}</textarea><br>
        <label for="myTextArea2">Catatan Elektro:</label><br>
        <textarea id="myTextArea2" rows="4" cols="45" >${catatanElektro}</textarea>`,
      confirmButtonText: 'OK',
      customClass: {
        confirmButton: 'btne btn-success' // Menambahkan kelas CSS 'btn-success' untuk tombol "OK"
      },
