  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
 						<a href="<?= base_url('Packing/HasilPacking') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
                ...
                <li><a href="<?= base_url('Produksi/KemajuanProduksi/detail_lila/' . $penerimaan->kode_transaksi)?>" class="dropdown-item">Lila</a></li>    
					...
					<div class="card-body">
                      ...
                      <th><strong></strong></th>
                        ...
                        <td><a href="<?= base_url('Packing/HasilPacking/detailHapus/' . $detail_terima->id_detail) ?>"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
 											</tr>
										<?php endforeach ?>
									</tbody>
									<tfoot>
