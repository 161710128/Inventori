        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card-header">
                ...
                <h3 class="card-title float-right"><a href="<?= base_url('PurchasingMekanik/BarangInventaris_Mekanik/tambahInventarisMesin') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3> 
            </div>
						...
						<tbody>
							<?php foreach ($all_barang as $barang): ?>
								<tr>
									...
									<td>
										<a href="<?= base_url('PurchasingMekanik/BarangInventaris_Mekanik/ubahIM/' . $barang->kode_part) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
										<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('PurchasingMekanik/BarangInventaris_Mekanik/hapusIM/' . $barang->kode_part) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
									</td> 
								</tr>
							<?php endforeach ?>
						</tbody>
