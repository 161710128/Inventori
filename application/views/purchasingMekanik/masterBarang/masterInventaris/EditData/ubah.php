				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-6">
							...
							<!-- /.card-header -->
								<div class="card-body">
									<form action="<?= base_url('PurchasingMekanik/BarangInventaris_Mekanik/proses_ubah/' . $barang->kode_part) ?>" id="form-tambah" method="POST">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label for="nama_barang"><strong>Nama Komponen</strong></label>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<select name="satuan" id="satuan" class="form-control" required>
													...
													<option value="lente" <?= $barang->satuan == 'lente' ? 'selected' : '' ?>>Lente</option> 
												</select>
											</div> 
											<div class="form-group col-md-6">
