      ...
      <div class="container-fluid">
        <div class="row mb-2">  
          <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('PurchasingMekanik/BarangMekanik/antropometri') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('PurchasingMekanik/BarangMekanik/proses_ubah_antropometri/' . $barang->kode_komponen) ?>" id="form-tambah" method="POST">
                <div class="card-body">
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="kode_komponen"><strong>Kode Komponen</strong></label>
							<input type="text" name="kode_komponen" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required value="<?= $barang->kode_komponen ?>">
						</div>
						<div class="form-group col-md-6">
          ...
          <div class="form-row">  
            <div class="form-group col-md-6">
                ...
                <select name="kebutuhan" id="kebutuhan" class="form-control" required>
                  ...
                  <option value="-" <?= $barang->kebutuhan == '-' ? 'selected' : '' ?>>-</option>
          ...
          <div class="form-row">   
            <div class="form-group col-md-6">
              ...
              <select name="tipe_barang" id="tipe_barang" class="form-control" required>
                ...
                <option value="-" <?= $barang->kebutuhan == '-' ? 'selected' : '' ?>>-</option> 
                <option value="prioritas" <?= $barang->type_barang == 'prioritas' ? 'selected' : '' ?>>Prioritas</option> 
              </select>
            </div>  
            <div class="form-group col-md-6">
