				...
				<div class="container-fluid">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="<?= base_url('PurchasingMekanik/BarangMekanik/hfnc') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-6">
									...
									<div class="card card-primary">
										...
										<!-- /.card-header -->
										<!-- form start -->
										<form action="<?= base_url('PurchasingMekanik/BarangMekanik/proses_tambahAntropometri') ?>" id="form-tambah" method="POST">
											<div class="card-body">
												<div class="form-row">
													<div class="form-group col-md-6">
														<label for="kode_komponen"><strong>Kode Komponen</strong></label>
														<input type="text" name="kode_komponen" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control" required value="MA<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
													</div>
													<div class="form-group col-md-6">
												...
												<div class="form-row">
													<div class="form-group col-md-6">
														<label for="spesifikasi"><strong>Spesikasi</strong></label>
												...
												<input type="hidden" name="stok_alat" value="Antropometri"> 
											</div>
											<!-- /.card-body -->
