							...
							<div class="row">
								<div class="col-6">
									...
									<div class="card card-primary">
										...
										<!-- /.card-header -->
										<!-- form start -->
										<form action="<?= base_url('PurchasingMekanik/BarangMekanik/proses_tambahHFNC') ?>" id="form-tambah" method="POST">
											<div class="card-body">
												<div class="form-row">
													<div class="form-group col-md-6">
														<label for="kode_komponen"><strong>Kode Komponen</strong></label>
														<input type="text" name="kode_komponen" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control" required value="MH<?php echo sprintf("%04s", $kode_komponen) ?>" maxlength="8" readonly>
													</div>
													<div class="form-group col-md-6">
