								...
								<div class="col-12">
									<div class="card">
										<div class="card-header">
											<?php $this->load->view("partials/dropDown"); ?>
										</div>

										<div class="card-body">
											<table id="example1" class="table table-bordered table-striped">
												<h3 class="card-title float-right"><a href="<?= base_url('PurchasingMekanik/BarangMekanik/tambahAntropometri') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
												<thead>
													<tr>
														<th>No</th>
														<th>Kode Komponen</th>
														...
														<tr>
															...
															<td>
																<?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'mekanik'|| $this->session->login['role'] == 'supervisor') : ?>
																	<a href="<?= base_url('PurchasingMekanik/BarangMekanik/ubahAntropometri/' . $barang->kode_komponen) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
