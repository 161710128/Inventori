            ...
            <!-- <div class="card-header">
                ...
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Tampilkan Data</a>
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                      ...
                      <li><a href="<?= base_url('PurchasingMekanik/BarangMekanik/antropometri') ?>" class="dropdown-item">Antropometri</a></li> 
                    </ul>
             </div> -->
             <div class="card-header"> 
                <h3 class="card-title float-right"><a href="<?= base_url('PurchasingMekanik/BarangMekanik/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
              </div>
          <div class="card-body">
                ...
                <th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                    ...
                    <?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'mekanik' || $this->session->login['role'] == 'supervisor') : ?>
                      <a href="<?= base_url('PurchasingMekanik/BarangMekanik/ubah/' . $barang->kode_komponen) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
                      <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('PurchasingMekanik/BarangMekanik/hapus/' . $barang->kode_komponen) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                    <?php endif; ?>
                  </td> 
								</tr>
							<?php endforeach ?>
