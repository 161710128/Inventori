                  ...
                  <tbody>
                    <?php foreach ($all_barang as $penerimaan): ?>
                      <tr>
                        ...
                        <td>
                          <!-- <a href="<?= base_url('PurchasingMekanik/PenerimaanInventaris_Mekanik/detail/' . $penerimaan->id_pinjam) ?>" class="btn btn-success btn-sm" ><i class="fa fa-eye"></i></a> -->
                          ...
                          <a href="<?= base_url('PurchasingMekanik/PengembalianBarang/ubah/' . $penerimaan->id_pinjam) ?>"  class="btn btn-success btn-sm">Dikembalikan</a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
