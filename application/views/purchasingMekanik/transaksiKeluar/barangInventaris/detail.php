  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
		<h3 class="m-0 float-right"><a href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h3> 
		  ...
		  <div class="row">
			...
			<hr> 
                ...
                <td><strong>Aksi</strong></td>
                  ...
                  <td><?= $detail_keluar->tanggal?> - <?= $detail_keluar->jam?></td>
                  <td><a href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/detailHapus/' . $detail_keluar->id_detail) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
								</tr>
							<?php endforeach ?>
						</tbody>
						<tfoot>
