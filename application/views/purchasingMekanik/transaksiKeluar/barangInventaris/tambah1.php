  ...
  <!-- Navbar -->
	...
	<!-- /.navbar -->
		...
		<div id="content-wrapper" class="content-wrapper" > 
			...
			<section id="content" class="content" data-url="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik') ?>">
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							...
							<!-- /.card-header -->
							<div class="card-body">
								<form action="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/proses_tambah') ?>" id="form-tambah" method="POST">
									<h5>Data Pengguna</h5>
									<hr>
									<div class="form-row">
										<div class="form-group col-2">
											<label>Kode Transaksi</label>
											<input type="text" name="kode_transaksi" value="IK<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly class="form-control">
										</div>
									...
									<div class="row"> 
										<div class="col-md-12">
											...
											<div class="form-row">
												...
												<input type="hidden" name="inventaris" value="">
			...
			if($(this).val() == '') reset()
				...
				$.ajax({
					...
					success: function(data){
						...
						$('input[name="inventaris"]').val(data.inventaris)
