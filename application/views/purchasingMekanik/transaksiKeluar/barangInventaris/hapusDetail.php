      ...
      <div class="container-fluid">
        <div class="row mb-2">  
          <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('purchasingMekanik/PengeluaranInventaris_Mekanik') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <!-- <form action="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/proses_detailHapus/' . $barang->kode_part) ?>" id="form-tambah" method="POST"> -->

              <form action="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="kode_komponen"><strong>Kode Komponen</strong></label>
                        <input type="text" name="kode_komponen" placeholder="Masukkan Kode Barang" autocomplete="off"  class="form-control" required value="<?= $barang->kode_part ?>" readonly>
                      </div>
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                       <div class="form-group col-md-6">
                          ...
                          <input type="text" name="spesifikasi" placeholder="Masukkan QTY /Unit" autocomplete="off"  class="form-control" required value="<?= $barang->spesifikasi?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="keterangan" placeholder="Masukkan Harga Satuan" autocomplete="off"  class="form-control" required value="<?= $barang->keterangan ?>"readonly>
                        </div>	
                        <div class="form-group col-md-6">
