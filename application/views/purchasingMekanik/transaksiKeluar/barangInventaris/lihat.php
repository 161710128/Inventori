  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
        <h3 class="m-0 float-right"><a href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3> 
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php foreach ($all_inventaris as $pengeluaran): ?>
                            <tr>
                              <td><?= $no++ ?></td>
                              ...
                              <!--<td><?= $pengeluaran->tanggal_keluar ?> <?= $pengeluaran->jam_keluar ?></td>-->
									...
									<td><?= $newDate?></td>
                              <td>
                                <a href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/detail/' . $pengeluaran->kode_transaksi) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                <!-- <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/hapus/' . $pengeluaran->kode_transaksi) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a> -->
                                <a href="<?= base_url('PurchasingMekanik/PengeluaranInventaris_Mekanik/ubah/' . $pengeluaran->kode_transaksi) ?>"  class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                              </td>
                            </tr>
                          <?php endforeach ?>
                        </tbody>
