                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="kode_transaksi" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control"  value="IK<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="tanggal_keluar"><strong>Tanggal Terima</strong></label>
                      <input type="text" name="tanggal_keluar"  autocomplete="off" class="form-control" value="<?= date('d-m-Y') ?>">
                    </div>
                  </div> 
                  <div class="form-row">
                    <div class="form-group col-md-6">
