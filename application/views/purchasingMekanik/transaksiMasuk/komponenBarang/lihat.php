												...
												<tbody>
													<?php foreach ($all_penerimaan as $penerimaan) : ?>
														<tr>
															...
															<!--<td><?= $penerimaan->tanggal_masuk ?></td> -->
																<?php 
															...
															<td><?= $newDate?></td>
															<td>
																<a href="<?= base_url('PurchasingMekanik/PenerimaanMekanik/detail/' . $penerimaan->kode_transaksi) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
																<?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'elektro'|| $this->session->login['role'] == 'supervisor') : ?>
																	<!-- <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('PurchasingMekanik/PenerimaanMekanik/hapus/' . $penerimaan->kode_transaksi) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a> -->
																<?php endif; ?>
																<a href="<?= base_url('PurchasingMekanik/PenerimaanMekanik/ubah/' . $penerimaan->kode_transaksi) ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
															</td>
														</tr>
													<?php endforeach ?>
												</tbody>
