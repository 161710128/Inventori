                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
													<li><a href="<?= base_url('PurchasingMekanik/PenerimaanMekanik/tambahEdit_Hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li>
													<li><a href="<?= base_url('PurchasingMekanik/PenerimaanMekanik/tambahEdit_Antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
												</ul>
                                            </h3>  
                                            <div class="float-right"><a href="<?= base_url('PurchasingElektro/PenerimaanMekanik') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?= base_url('PurchasingMekanik/PenerimaanMekanik/proses_tambahEdit') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
