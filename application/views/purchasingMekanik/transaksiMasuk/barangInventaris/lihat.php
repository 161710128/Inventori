  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
        <h3 class="m-0 float-right"><a href="<?= base_url('PurchasingMekanik/PenerimaanInventaris_Mekanik/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3> 
