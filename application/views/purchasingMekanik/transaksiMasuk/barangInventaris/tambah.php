                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="kode_transaksi" placeholder="Masukkan Kode Barang" autocomplete="off" class="form-control"  value="IM<?php echo sprintf("%03s", $kode_transaksi) ?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
