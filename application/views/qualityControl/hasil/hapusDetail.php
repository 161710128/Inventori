        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url('QualityControl/StokAlat/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="total_accept"><strong>Total Accept</strong></label>
                          <input type="text" name="total_accept" autocomplete="off"  class="form-control" required value="<?= $barang->total_accept ?>"readonly>
                        </div>	
                        <div class="form-group col-md-6">
                          <label for="total_reject"><strong>Total Reject</strong></label>
                          <input type="text" name="total_reject" autocomplete="off"  class="form-control" required value="<?= $barang->total_reject ?>"readonly>
                        </div>
                    </div>
                    <div class="form-row">
