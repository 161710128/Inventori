  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
 						<a href="<?= base_url('QualityControl/StokAlat') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
                ...
                <li><a href="<?= base_url('Produksi/KemajuanProduksi/detail_lila/' . $penerimaan->kode_transaksi)?>" class="dropdown-item">Lila</a></li>    
                    ...
                    <td> 
                      ...
                      <th><strong>Total Accept</strong></th>
                      <th><strong>Total Reject</strong></th>
									...
									<tbody>
										<?php foreach ($all_detail_terima as $detail_terima): ?>
											<tr>
												...
												<td><?= $detail_terima->total_accept ?></td> 
												<td><?= $detail_terima->total_reject ?></td> 
												<td><?= $detail_terima->catatan ?></td> 
												<td><?= $detail_terima->nama_shift ?></td>
                        <td><a href="<?= base_url('QualityControl/StokAlat/detailHapus/' . $detail_terima->id_detail) ?>"  class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
