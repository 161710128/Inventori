		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">							
							<h3 class="card-title float-right"><a href="<?= base_url('QualityControl/MasterAlat/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
												...
												<tbody>
													<?php foreach ($all_barang as $barang) : ?>
														<tr>
															...
															<td><?= $barang->total_accept ?></td>   
															<td><?= $barang->stok_alat ?></td>   
															<td><?= $barang->keterangan ?></td>   
															<td>
																<?php if ($this->session->login['role'] == 'super' || $this->session->login['role'] == 'quality') : ?>
																	<a href="<?= base_url('QualityControl/MasterAlat/ubah/' . $barang->kode_alat) ?>" class="btn btn-success btn-sm"><i class="fa fa-pen"></i></a>
																	<a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('QualityControl/MasterAlat/hapus/' . $barang->kode_alat) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
																<?php endif; ?>
															</td>
														</tr>
													<?php endforeach ?> 
