      ...
      <div class="container-fluid">
        <div class="row mb-2">  
          <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('GudangBahanRM/Penerimaan') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <!-- <form action="<?= base_url('GudangBahanRM/Penerimaan/proses_detailHapus/' . $barang->kode_komponen) ?>" id="form-tambah" method="POST"> -->
              <form action="<?= base_url('GudangBahanRM/Penerimaan/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
