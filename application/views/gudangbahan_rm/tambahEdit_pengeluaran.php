                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <!-- <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
                                                    <li><a href="<?= base_url('GudangBahanRM/Pengeluaran/tambahEdit_hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li> 
                                                    <li><a href="<?= base_url('GudangBahanRM/Pengeluaran/tambahEdit_antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
                                                </ul>
                                            </h3>   -->
                                        ...
                                        <div class="card-body">
                                            <form action="<?= base_url('GudangBahanRM/Pengeluaran/proses_tambahEdit') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
       ...
       $(document).ready(function() {
            ...
            $('#kode_komponen').on('change', function() { 
                if ($(this).val() == '') reset()
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>GudangBahanRM/Pengeluaran/get_all_barang",
                        type: 'POST',
                        dataType: 'json',
                        data: {
            ...
            $(document).on('click', '#tambah', function(e) {
                ...
                $.ajax({
                    url: "<?= base_url() ?>GudangBahanRM/Pengeluaran/keranjang_barang",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
