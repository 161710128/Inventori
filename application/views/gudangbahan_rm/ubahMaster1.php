        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= base_url('GudangBahanRM/BautMur_DataMaster/proses_ubah/' . $barang->kode_komponen) ?>" id="form-tambah" method="POST">
                <div class="card-body">
					<div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" name="spesifikasi" placeholder="Masukkan Harga Satuan" autocomplete="off"  class="form-control" required value="<?= $barang->spesifikasi ?>">
              </div>	
              <div class="form-group col-md-6">
          ...
          <div class="form-row">  
            ...
            <div class="form-group col-md-6">
                ...
                $checkbox_values = explode(',', $barang->kebutuhan);

                $checkboxes = array('Endoscopy', 'Antropometri', 'Dental', 'Lightsource', 'Suction Irigation');

                // Loop untuk menampilkan checkbox
                foreach ($checkboxes as $checkbox) {
                    $checked = in_array($checkbox, $checkbox_values) ? 'checked' : '';
                ?>
                    <label for="<?php echo $checkbox; ?>">
                        <?php echo form_checkbox('kebutuhan[]', $checkbox, $checked, 'id="' . $checkbox . '"'); ?> <?php echo $checkbox; ?>
                    </label><br>
                <?php
                }
                ?>
