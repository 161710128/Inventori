							...
							<div class="row">
								<div class="col-6">
									...
									<div class="card card-primary">
										...
										<!-- /.card-header -->
										<!-- form start -->
										<form action="<?= base_url('GudangBarangJadi/DataMaster/proses_tambah') ?>" id="form-tambah" method="POST">
											<div class="card-body">
												<div class="form-row">
													...
													<div class="form-group col-md-6">
														...
														<input type="text" name="keterangan_kode" placeholder="Masukkan Keterangan Kode" autocomplete="off" class="form-control" required>
													</div>
												</div>
												<div class="form-row">
													<div class="form-group col-md-6">
												...
												<div class="form-row">
													...
													<div class="form-group col-md-6">
														...
														<select name="jenis_komponen" id="jenis_komponen" class="form-control" required>
															...
															<option value="Ent/THT">Ent/THT</option>
															<option value="Hysteroscopy">Hysteroscopy</option>
															<option value="Laparoscopy">Laparoscopy</option>
															<option value="Electric hysteria cutter(morcellator)">Electric hysteria cutter(morcellator)</option>
															<option value="Vats video Assisted thoracoscopy">Vats video Assisted thoracoscopy</option>
															<option value="Arthroscpoy">Arthroscpoy</option>
															<option value="Spine">Spine</option>
															<option value="Urology">Urology</option>
															<option value="Endoscopy Scope">Endoscopy Scope</option>
												...
												<div class="form-row">  
													...
													<div class="form-group col-md-6">
														...
														<input type="text" name="lokasi" placeholder="Masukkan Lokasi" autocomplete="off" class="form-control" required>
													</div> 
												</div>
												<div class="form-row">  
													<div class="form-group col-md-6">
												...
												<div class="form-row">   
													<div class="form-group col-md-6">
														...
														<textarea name="kebutuhan" placeholder="Masukkan Kebutuhan Alat" autocomplete="off" class="form-control" rows="5" cols="50" required></textarea>
													</div>  
												</div> 
        ...
        $(document).ready(function() {
            $('#jenis_komponen').change(function() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {'jenis_komponen': selectedValue},
