        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <!-- <form action="<?= base_url('GudangBarangJadi/Pengeluaran/proses_detailHapus/' . $barang->kode_komponen) ?>" id="form-tambah" method="POST"> -->
              <form action="<?= base_url('GudangBarangJadi/Pengeluaran/proses_detailHapus') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                    <div class="form-row">
