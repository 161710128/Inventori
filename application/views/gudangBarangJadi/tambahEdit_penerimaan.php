                                        ...
                                        <div class="card-header">
                                            <!-- <h3 class="card-title">
                                                ...
                                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"> 
													<li><a href="<?= base_url('GudangBarangJadi/Penerimaan/tambahEdit_Hfnc/' . $barang->kode_transaksi) ?>" class="dropdown-item">HFNC</a></li>
													<li><a href="<?= base_url('GudangBarangJadi/Penerimaan/tambahEdit_Antropometri/' . $barang->kode_transaksi) ?>" class="dropdown-item">Antropometri</a></li> 
												</ul>
                                            </h3>   -->
                                            <div class="float-right"><a href="<?= base_url('GudangBarangJadi/Penerimaan') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></div>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?= base_url('GudangBarangJadi/Penerimaan/proses_tambahEdit') ?>" id="form-tambah" method="POST">
                                                <h5>Data Pengguna</h5>
                                                <hr>
                                                <div class="form-row">
        ...
        $(document).ready(function() {
            ...
            $('#kode_komponen').on('change', function() {
                ...
                if ($(this).val() == '') reset()
                    ...
                    $.ajax({
                        url: "<?= base_url() ?>GudangBarangJadi/Penerimaan/get_all_barangPenerimaan",
                        type: 'POST',
                        dataType: 'json',
                        data: {
            ...
            $(document).on('click', '#tambah', function(e) {
                const url_keranjang_barang = $('#content').data('url') + '/keranjang_barangPenerimaan'
                ...
                $.ajax({
                    url: "<?= base_url() ?>GudangBarangJadi/Penerimaan/keranjang_barangPenerimaan",
                    type: 'POST',
                    data: data_keranjang,
                    success: function(data) {
