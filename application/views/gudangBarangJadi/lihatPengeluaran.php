		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12">
						<h3 class="card-title float-right"><a href="<?= base_url('GudangBarangJadi/Pengeluaran/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a></h3>
											...
											<div class="card-body">
												...
												<div class="table-responsive">
													<!-- <div class="float-right">
														<a href="<?= base_url('GudangBarangJadi/Pengeluaran/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</a>
													</div> -->
														...
														<tbody>
															<?php foreach ($all_pengeluaran as $pengeluaran) : ?>
																<tr>
																	...
																	<td>
																		<a href="<?= base_url('GudangBarangJadi/Pengeluaran/detail/' . $pengeluaran->kode_transaksi) ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a> 
																		<a href="<?= base_url('GudangBarangJadi/Pengeluaran/tambahUbah/' . $pengeluaran->kode_transaksi) ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
																	</td>
																</tr>
															<?php endforeach ?>
														</tbody>
