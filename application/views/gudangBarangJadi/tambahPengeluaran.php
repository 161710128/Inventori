 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-12"> 
            ...
            <h1 class="float-right"><a href="<?= base_url('GudangBarangJadi/Pengeluaran') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a></h1> 	
          </div>
        </div>
        <!-- /.row -->
		<hr>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <div class="card card-primary">
              ...
              <form action="<?= base_url('GudangBarangJadi/Pengeluaran/proses_tambah') ?>" id="form-tambah" method="POST">
                <div class="card-body">
                  <div class="form-row">
