  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="float-right">
 						<a href="<?= base_url('GudangBarangJadi/Penerimaan') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
					</div>
        <div class="row mb-2">
          	<div class="col-sm-6"> 
					...
					<div class="card-body">
                      ...
                      <th><strong>Kode Komponen</strong></th>
                        ...
                        <td>																
                          ...
                          <a href="<?= base_url('GudangBarangJadi/Penerimaan/detailHapus/' . $detail_terima->id_detail) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
											</tr>
										<?php endforeach ?>
									</tbody>
